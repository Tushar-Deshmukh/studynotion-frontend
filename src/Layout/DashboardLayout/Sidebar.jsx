...
export default function Sidebar({ openSidebar, closeSidebar }) {
  return (
    <div>
      <aside
        id="default-sidebar"
        className={`fixed top-[79px] left-0 z-40 w-64 h-screen transition-transform ${
          openSidebar ? "translate-x-0" : "-translate-x-full"
        } lg:translate-x-0`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#161D29] border-r border-[#2C333F]">
